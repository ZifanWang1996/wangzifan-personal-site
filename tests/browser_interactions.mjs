...
assert.equal(projectSpecs.length, 28, 'dynamic fixture must include every live project card');
...
for (const [value, expected] of [['ai', 3], ['game', 9], ['tool', 9], ['creative', 7], ['all', 28]]) {
